...
```
(screenshots/Day-5_Networking_basics_ping.png)
(screenshots/Day-5_Networking_basics_curl_ss_install_netstat_cmd)
(screenshots/Day-5_Networking_basics_netstat_ss_-tuln_dig+short_traceroute_sudo_apt_install_cmd)
(screenshots/Day-5_Networking_basics_sudo_apt_install_traceroute_cmd)
(screenshots/Day-5_Networking_basics_traceroute_cmd)
(screenshots/Day-5_Networking_basics_ping_curl_ss_netstat_dig_traceroute_cmd)
